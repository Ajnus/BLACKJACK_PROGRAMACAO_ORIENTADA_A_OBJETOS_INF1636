...
public class TelaInicio extends JPanel implements ActionListener {
	...
	public TelaInicio(int LARGURA, int ALTURA) {
		setLayout(null);
		...
		for (int i = 0; i < 4; i++) {
			if (i == 0) {
				...
				jogadores[i].addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) { // jogar futuramente essa funcionalidade para o
																	// controller para poder pegar a quantidade de
																	// jogadores.
						stateIniciar = false;
					}
				});
